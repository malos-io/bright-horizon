...
def get_application_withdrawn_email_html(name: str, course: str) -> str:
    logo_url = f"{PUBLIC_API_URL}/static/logo-email.png"
    home_url = f"{PUBLIC_FRONTEND_URL}/"
                ...
                <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <p style="margin:0 0 20px; color:#555; font-size:15px; line-height:1.6;">
                                We confirm that your application for the following course has been <strong>withdrawn</strong> per your request:
                            </p>
                            <!-- Course Box -->
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 25px;">
                                <tr>
                                    <td align="center" style="background:#fef2f2; border:1px solid #fecaca; border-radius:10px; padding:18px 24px;">
                                        <p style="margin:0; font-size:17px; color:#991b1b; font-weight:700;">{course}</p>
                                    </td>
                                </tr>
                            </table>
                            <p style="margin:0 0 20px; color:#555; font-size:15px; line-height:1.6;">
                                If you change your mind, you are welcome to submit a new application at any time through our website.
                            </p>
                            <!-- CTA Button -->
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding:0 0 25px;">
                                        <a href="{home_url}" style="display:inline-block; background:#1a5fa4; color:#ffffff; font-size:15px; font-weight:600; padding:14px 32px; border-radius:8px; text-decoration:none;">Visit Our Website</a>
                                    </td>
                                </tr>
                            </table>
