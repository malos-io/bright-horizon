...
def get_documents_accepted_email_html(name: str) -> str:
                ...
                <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <p style="margin:0 0 20px; color:#555; font-size:15px; line-height:1.6;">
                                To complete your enrollment, please visit our office and bring the <strong>original copies</strong> of the documents you submitted for verification.
                            </p>
                            <p style="margin:0 0 25px; color:#555; font-size:15px; line-height:1.6;">
                                Our admissions team will review your original documents on-site. We look forward to welcoming you at Bright Horizon Institute!
                            </p>
