...
def get_batch_assigned_email_html(
    name: str,
    course: str,
    start_date: str,
) -> str:
                ...
                <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 4px 16px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="background:linear-gradient(135deg, #14532d 0%, #166534 100%); padding:28px 40px; text-align:center;">
                            ...
                            <h1 style="margin:0; color:#ffffff; font-size:24px; font-weight:700;">You Have Been Assigned to a Class!</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:36px 40px 20px;">
                            ...
                            <p style="margin:0 0 20px; color:#334155; font-size:15px; line-height:1.7;">
                                We are pleased to inform you that you have been assigned to a class for <strong>{course}</strong> at Bright Horizon Institute. Your student account has been activated.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 25px; border:1px solid #e2e8f0; border-radius:10px; overflow:hidden;">
                                <tr>
                                    <td colspan="2" style="background:#f8fafc; padding:14px 20px; border-bottom:1px solid #eef2f7;">
                                        <strong style="color:#1a1a2e; font-size:14px; text-transform:uppercase; letter-spacing:0.05em;">Your Class Details</strong>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="padding:12px 20px;">
                                        <span style="color:#64748b; font-size:13px; text-transform:uppercase; letter-spacing:0.05em;">Tentative Start Date</span><br>
                                ...
                                <tr>
                                    <td style="background:#fffbeb; border:1px solid #fde68a; border-radius:10px; padding:18px 20px;">
                                        <p style="margin:0; color:#92400e; font-size:14px; line-height:1.6;">
                                            <strong>Important:</strong> The start date above is tentative. If this date does not work for you, please call our office as soon as possible so we can update your schedule.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin:0 0 8px; color:#334155; font-size:15px; line-height:1.7;">
                                We are excited to have you on board and look forward to a great learning experience!
                            </p>
                        </td>
                    </tr>
