...
def get_admin_new_application_email_html(
    applicant_name: str,
    email: str,
    contact_no: str,
    course: str,
                ...
                <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:40px;">
                            <h2 style="margin:0 0 10px; color:#1a1a2e; font-size:22px;">New Application Received</h2>
                            <p style="margin:0 0 20px; color:#555; font-size:15px; line-height:1.6;">
                                A new enrollment application has been submitted. Here are the details:
                            </p>
                            <!-- Applicant Details -->
                                    ...
                                    <td style="background:#f8f9fb; border:1px solid #e8e8e8; border-radius:10px; padding:20px 24px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:6px 0; color:#0d3b6e; font-size:15px; font-weight:700;">{course}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
